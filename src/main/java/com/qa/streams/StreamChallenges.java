...
//        3. Suggestions: peek, limit, count, takeWhile, skip, findAny, findFirst, reduce
    public static void taskF() {
        List<String> cohort1 = new ArrayList<>(List.of("Abdul", "Aiman", "Ano", "Bryan", "Daveraj", "Ilia", "Jibril", "Maksym", "Panya", "Saranya", "Schivanee"));

        List<String> betterCohort1 = cohort1.stream().filter(e -> e.length() > 5 ).peek(e -> System.out.println("Filtered Value (1st Peek): "+ e))
